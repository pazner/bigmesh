...
struct VTKGeometry
{
   ...
   ///@{
   static const int64_t POINT = 1;

   /// @name Low-order (linear, straight-sided) VTK geometric types
   ///@{
   static const int64_t SEGMENT = 3;
   static const int64_t TRIANGLE = 5;
   static const int64_t SQUARE = 9;
   static const int64_t TETRAHEDRON = 10;
   static const int64_t CUBE = 12;
   static const int64_t PRISM = 13;
   static const int64_t PYRAMID = 14;
   ///@}

   /// @name Legacy quadratic VTK geometric types
   ///@{
   static const int64_t QUADRATIC_SEGMENT = 21;
   static const int64_t QUADRATIC_TRIANGLE = 22;
   static const int64_t BIQUADRATIC_SQUARE = 28;
   static const int64_t QUADRATIC_TETRAHEDRON = 24;
   static const int64_t TRIQUADRATIC_CUBE = 29;
   static const int64_t QUADRATIC_PRISM = 26;
   static const int64_t BIQUADRATIC_QUADRATIC_PRISM = 32;
   static const int64_t QUADRATIC_PYRAMID = 27;
   ///@}

   /// @name Arbitrary-order VTK geometric types
   ///@{
   static const int64_t LAGRANGE_SEGMENT = 68;
   static const int64_t LAGRANGE_TRIANGLE = 69;
   static const int64_t LAGRANGE_SQUARE = 70;
   static const int64_t LAGRANGE_TETRAHEDRON = 71;
   static const int64_t LAGRANGE_CUBE = 72;
   static const int64_t LAGRANGE_PRISM = 73;
   static const int64_t LAGRANGE_PYRAMID = 74;
   ///@}
   ///@}

   /// Permutation from MFEM's prism ordering to VTK's prism ordering.
   static const int64_t PrismMap[6];
